...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.0, 267.0, 204.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 292.0, 265.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.0, 285.0, 44.0, 20.0 ],
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 770.0, 455.0, 33.0, 20.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 492.5, 782.0, 188.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 699.0, 568.0, 69.0, 20.0 ],
					"text" : "jit.transpose",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 169.0, 37.0, 20.0 ],
					"text" : "poker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 492.5, 712.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 492.5, 670.0, 30.0, 20.0 ],
					"text" : "jit.+"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1083.0, 214.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 984.0, 203.0, 34.0, 20.0 ],
					"text" : "targo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 276.0, 69.0, 20.0 ],
					"text" : "pak poker 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1031.0, 306.0, 141.0, 20.0 ],
					"text" : "matrix_name $1, plane $2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 699.0, 485.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 699.0, 670.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 699.0, 533.0, 178.0, 20.0 ],
					"text" : "jit.matrix targo 3 float32 100 100",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 492.5, 485.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 492.5, 563.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 864.0, 285.0, 103.0, 20.0 ],
					"text" : "scale~ -1 1 25 75",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 864.0, 255.0, 71.0, 20.0 ],
					"text" : "cycle~ 0.31",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 749.0, 285.0, 103.0, 20.0 ],
					"text" : "scale~ -1 1 3 100",
					"textcolor" : [ 0.072298, 0.553854, 0.249921, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 749.0, 255.0, 54.0, 20.0 ],
					"text" : "cycle~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 634.0, 285.0, 99.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 634.0, 255.0, 71.0, 20.0 ],
					"text" : "cycle~ 0.25",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 492.5, 533.0, 181.0, 20.0 ],
					"text" : "jit.matrix poker 3 float32 100 100",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "jit_matrix" ],
					"patching_rect" : [ 634.0, 370.0, 249.0, 20.0 ],
					"text" : "the.jit.poke~ habenula poker 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 291.0, 38.0, 20.0 ],
					"text" : "reveal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.0, 291.0, 29.5, 20.0 ],
					"text" : "dir"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 292.0, 327.0, 125.0, 20.0 ],
					"text" : "jit.world xen @enable 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "bang", "" ],
					"patching_rect" : [ 171.0, 375.0, 140.0, 20.0 ],
					"text" : "the.jit.renderer~ habenula",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 1040.5, 347.5, 643.5, 347.5 ],
					"source" : [ "obj-29", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 301.5, 409.0, 426.5, 409.0, 426.5, 316.0, 301.5, 316.0 ],
					"source" : [ "obj-5", 4 ]
				}
