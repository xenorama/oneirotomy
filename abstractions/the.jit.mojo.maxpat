...
,
					"patching_rect" : [ 543.0, 205.74450820684433, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.5, 523.48901641368866, 83.0, 20.0 ],
					"text" : "prepend active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.5, 553.418686123963539, 76.0, 20.0 ],
					"text" : "s #0_state",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.071428571428555, 346.224537112794792, 92.0, 20.0 ],
					"text" : "s #0_getstate",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 850.0, 259.224537112794792, 76.0, 20.0 ],
					"text" : "s #0_state",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 96.0, 132.0, 20.0 ],
...
,
					"patching_rect" : [ 810.0, 174.0, 59.0, 20.0 ],
					"saved_object_attributes" : 					{
						"color" : [ 0.937255, 0.763913, 0.302615, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 775.0, 205.74450820684433, 94.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 586.5, 401.72546112537384, 128.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 373.0, 458.72546112537384, 198.0, 20.0 ],
					"text" : "the.thalamus.synapsis #1 jit.mojo",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 661.0, 744.5, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 742.0, 611.5, 52.0, 20.0 ],
					"text" : "clip 0. 1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 742.0, 683.5, 85.0, 20.0 ],
					"text" : "* 30.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 950.5, 611.5, 55.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.5, 643.977830529212952, 334.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 808.0, 641.5, 56.0, 20.0 ],
					"text" : "route dim",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 808.0, 611.5, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.5, 767.0, 51.0, 20.0 ],
					"text" : "gate 1 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 511.0, 777.0, 51.0, 20.0 ],
					"text" : "gate 1 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 511.0, 744.522169470787048, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-101",
					"items" : [ "bypass", ",", "operate", ",", "(no new recording (idle))", ",", "no rendering", ",", "no playback", ",", "mute" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 373.0, 494.48901641368866, 142.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 373.0, 617.0, 63.0, 20.0 ],
					"text" : "unpack i i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "active[1]"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 373.0, 585.0, 84.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.5, 1142.0, 150.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 331.5, 717.0, 29.5, 20.0 ],
					"text" : "t f 0",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.5, 1028.0, 84.0, 20.0 ],
					"text" : "prepend speed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 511.0, 1026.0, 84.0, 20.0 ],
					"text" : "prepend phase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 373.0, 674.0, 189.0, 20.0 ],
					"text" : "gate 3 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 563.5, 744.522169470787048, 55.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.5, 777.0, 316.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 543.0, 611.5, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 511.0, 842.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 676.5, 842.5, 29.5, 20.0 ],
					"text" : "* 2.",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 511.0, 990.75, 35.0, 20.0 ],
					"text" : "% 2.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 511.0, 948.0, 184.5, 20.0 ],
					"text" : "* 0.",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 563.5, 877.0, 30.0, 20.0 ],
					"text" : "!/ 1.",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 563.5, 842.5, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 511.0, 910.5, 71.5, 20.0 ],
					"text" : "* 0.016667",
					"textcolor" : [ 0.275282, 0.960371, 0.999055, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 116.0, 545.0, 64.5, 20.0 ],
					"text" : "t b i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 331.5, 611.5, 29.5, 20.0 ],
					"text" : "f 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 161.5, 674.0, 189.0, 20.0 ],
					"text" : "gate 3 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 510.0, 147.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 129.5, 1106.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 543.0, 174.0, 254.0, 32.0 ],
					"text" : "patcherargs #0 @speed 0. @name #0_unnamed",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 331.5, 312.0, 274.0, 20.0 ],
					"text" : "route speed active solo unsolo preview done getstate",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 686.0, 1478.0, 150.0, 30.0 ],
					"text" : "jit_matrix\nthrough/iterated"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 331.5, 199.0, 150.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 246.0, 280.0, 55.0 ],
					"text" : "requires:\n\n• the.jit.thalamus\n• render bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 183.0, 297.0, 42.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.jit.retina: (jit_matrix) pass through during playback, iterate through during offline rendering",
					"id" : "obj-17",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 688.0, 1446.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.5, 222.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 382.5, 656.5, 139.0, 656.5 ],
					"source" : [ "obj-102", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 426.5, 660.261084735393524, 520.5, 660.261084735393524 ],
					"source" : [ "obj-102", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 650.5, 439.72546112537384, 561.5, 439.72546112537384 ],
					"source" : [ "obj-19", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 3 ],
					"midpoints" : [ 596.0, 439.72546112537384, 561.5, 439.72546112537384 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 859.5, 301.0, 341.0, 301.0 ],
					"order" : 1,
					"source" : [ "obj-20", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 486.714285714285722, 387.25, 751.5, 387.25 ],
					"source" : [ "obj-3", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 960.0, 673.238915264606476, 817.5, 673.238915264606476 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 520.5, 1075.0, 139.0, 1075.0 ],
					"source" : [ "obj-90", 0 ]
				}
