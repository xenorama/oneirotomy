...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1269.0, 719.0, 43.0, 20.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1419.0, 857.0, 80.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1447.0, 591.0, 35.0, 20.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1447.0, 677.0, 115.0, 20.0 ],
					"text" : "jit.matrix #2_rec",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1447.0, 759.0, 125.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1612.333333333333485, 954.0, 258.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1818.0, 1245.2144775390625, 303.0, 165.0 ],
					"text" : "args: 1:1 from parent patcher\n\n#1 (symbol) = render context name\n#2 (symbol) = target matrix name\n(#3 (int) = dim[0] (auto-inherit: ignore))\n#4 (int) = planecount (default: 1) = dimcount (#3)\n#5 (bool) = dim inheit flag (default: off)\n\nattributes:\n\n@planemap (list) = planes to write to"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 1383.0, 1004.0, 305.666666666666742, 20.0 ],
					"text" : "the.matrix.storage #1 #2 1024 #3 1",
					"textcolor" : [ 0.2, 0.2, 0.2, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1784.0, 918.0, 72.0, 20.0 ],
					"text" : "pvar active 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1187.5, 243.0, 468.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 789.5, 936.0, 65.0, 20.0 ],
					"text" : "route plane",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1383.0, 1058.916663885116577, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "mc.poly~ the.mc.jit.amygdalae.nucleus #3 @target 0 @args #2_temp",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 979.5, 1125.208331227302551, 150.0, 20.0 ],
					"text" : "jit.poke~ #2_temp 1 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 790.5, 1125.208331227302551, 146.0, 32.0 ],
					"text" : "jit.poke~ #2_temp 1 0",
					"textcolor" : [ 0.949369, 0.306719, 0.105319, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 803.0, 179.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1424.0, 502.0, 125.0, 20.0 ],
					"text" : "jit.matrix #2_temp ",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1190.0, 1096.562497556209564, 1120.0, 1096.562497556209564 ],
					"order" : 0,
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1190.0, 1096.562497556209564, 927.0, 1096.562497556209564 ],
					"order" : 1,
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 1022.0, 616.0, 1085.25, 616.0, 1085.25, 230.0, 1197.0, 230.0 ],
					"source" : [ "obj-73", 4 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 1,
					"hidden" : 1,
					"midpoints" : [ 1089.5, 1046.104165613651276, 1120.0, 1046.104165613651276 ],
					"source" : [ "obj-97", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 1,
					"hidden" : 1,
					"midpoints" : [ 1089.5, 1047.104165613651276, 927.0, 1047.104165613651276 ],
					"source" : [ "obj-97", 0 ]
				}
