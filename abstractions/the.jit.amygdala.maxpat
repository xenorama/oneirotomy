...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 812.376007080078125, 320.0, 142.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 786.376007080078125, 275.0, 45.0, 20.0 ],
					"text" : "route 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1296.876007080078125, 366.0, 66.0, 20.0 ],
					"text" : "zl 2 change",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1166.0, 366.0, 66.0, 20.0 ],
					"text" : "zl 2 change",
					"textcolor" : [ 0.921569, 0.717647, 0.117647, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 939.969001770019531, 561.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 939.969001770019531, 593.0, 55.938003540039062, 20.0 ],
					"text" : "gate 1 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 886.969001770019531, 501.0, 72.0, 20.0 ],
					"text" : "pvar active 3",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 568.969001770019531, 738.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.969001770019531, 770.0, 86.938003540039062, 20.0 ],
					"text" : "gate 1 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.969001770019531, 711.0, 62.0, 20.0 ],
					"text" : "pvar active",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 812.376007080078125, 398.0, 63.0, 20.0 ],
					"text" : "unpack i i i",
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 812.376007080078125, 355.0, 84.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 689.376007080078125, 167.0, 121.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.126007080078125, 934.0, 111.0, 30.0 ],
					"text" : "jit_matrix\nthru/frame-by-frame"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 636.876007080078125, 70.0, 53.0, 30.0 ],
					"text" : "jit_matrix\nthru"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 308.2144775390625, 547.0, 64.0 ],
					"text" : "requires:\n\n• the.jit.amygdala~\n• the.jit.thalamus"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 219.2144775390625, 547.0, 64.0 ],
					"text" : "args:\n\n#1 (symbol) = render context name\n#2 (symbol) = spectram matrix name (to be written to using  the.jit.amygdala~)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1165.876007080078125, 396.0, 45.0, 20.0 ],
					"text" : "unpack",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1165.876007080078125, 335.0, 56.0, 20.0 ],
					"text" : "route dim",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1165.876007080078125, 305.0, 69.0, 20.0 ],
					"text" : "jit.matrixinfo",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1165.876007080078125, 275.0, 122.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 723.876007080078125, 355.0, 63.0, 20.0 ],
					"text" : "change -1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 723.876007080078125, 490.0, 29.5, 20.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 723.876007080078125, 453.5, 40.0, 20.0 ],
					"text" : "* 512.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.876007080078125, 320.0, 52.0, 20.0 ],
					"text" : "clip 0. 1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 723.876007080078125, 245.0, 144.0, 20.0 ],
					"text" : "route preview active",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 636.876007080078125, 203.0, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 601.438003540039062, 501.0, 22.0, 20.0 ],
					"text" : "t b",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 601.438003540039062, 434.5, 29.5, 20.0 ],
					"text" : "+ 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1264.876007080078125, 460.0, 83.0, 20.0 ],
					"text" : "pak dim 256 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1296.876007080078125, 396.0, 45.0, 20.0 ],
					"text" : "unpack",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1296.876007080078125, 335.0, 56.0, 20.0 ],
					"text" : "route dim",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1296.876007080078125, 305.0, 69.0, 20.0 ],
					"text" : "jit.matrixinfo",
					"textcolor" : [ 0.991343, 0.575888, 0.591121, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 1296.876007080078125, 275.0, 101.0, 20.0 ],
					"text" : "jit.matrix #2",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 887.376007080078125, 172.0, 297.5, 20.0 ],
					"text" : "t i 0 b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 887.376007080078125, 211.0, 56.0, 20.0 ],
					"text" : "decode 4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.626007080078125, 624.0, 34.0, 20.0 ],
					"text" : "gate",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 887.376007080078125, 110.0, 139.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 601.438003540039062, 471.0, 54.438003540039062, 20.0 ],
					"text" : "gate 2 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1060.126007080078125, 751.0, 92.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 924.626007080078125, 809.0, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 924.626007080078125, 711.0, 154.5, 20.0 ],
					"text" : "t b i",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 924.626007080078125, 751.0, 122.0, 20.0 ],
					"text" : "jit.matrix #2_rec",
					"textcolor" : [ 0.649909, 0.112638, 0.040011, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 924.626007080078125, 659.5, 155.0, 20.0 ],
					"text" : "counter",
...
, 			{
				"box" : 				{
					"comment" : "the.jit.amygdala: (jit_matrix) spectral matrix to pass through",
					"id" : "obj-149",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 636.876007080078125, 110.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.jit.amygdala: (jit_matrix) through, iterated during offline rendering",
					"id" : "obj-150",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.126007080078125, 896.5, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 733.376007080078125, 691.5, 934.126007080078125, 691.5 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1201.376007080078125, 435.25, 754.376007080078125, 435.25 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1069.626007080078125, 789.5, 934.126007080078125, 789.5 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-150", 0 ],
					"midpoints" : [ 934.126007080078125, 856.75, 578.626007080078125, 856.75 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 909.209340413411496, 394.75, 610.938003540039062, 394.75 ],
					"source" : [ "obj-43", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1175.376007080078125, 256.5, 1306.376007080078125, 256.5 ],
					"order" : 0,
					"source" : [ "obj-52", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"midpoints" : [ 1274.376007080078125, 789.5, 934.126007080078125, 789.5 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 610.938003540039062, 538.0, 986.407005310058594, 538.0 ],
					"source" : [ "obj-6", 0 ]
				}
