...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 548.0, 134.0, 77.0, 20.0 ],
					"text" : "change 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.5, 244.0, 35.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 457.0, 165.0, 43.0, 20.0 ],
					"text" : "edge~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 457.0, 134.0, 29.5, 20.0 ],
					"text" : "<~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 457.0, 104.0, 42.0, 20.0 ],
					"text" : "delta~",
					"textcolor" : [ 0.992157, 0.65098, 0.109804, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 298.166666666666686, 382.0, 190.0, 20.0 ],
					"text" : "fftout~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 298.166666666666686, 281.0, 139.0, 20.0 ],
					"text" : "jit.peek~ #1 1 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 468.166666666666686, 281.0, 139.0, 20.0 ],
					"text" : "jit.peek~ #1 1 1",
					"textcolor" : [ 0.937255, 0.763913, 0.302615, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 468.166666666666686, 308.0, 100.0, 20.0 ],
					"text" : "frameaccum~",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 298.166666666666686, 345.0, 190.0, 20.0 ],
					"text" : "poltocar~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 185.0, 87.0, 20.0 ],
					"text" : "phasewrap~",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 123.0, 90.0, 20.0 ],
					"text" : "framedelta~",
					"textcolor" : [ 0.992157, 0.65098, 0.109804, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 112.0, 281.0, 168.0, 20.0 ],
					"text" : "jit.poke~ #1 1 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.166666666666686, 336.0, 212.0, 20.0 ],
					"text" : "jit.poke~ #1 1 0",
					"textcolor" : [ 0.949369, 0.306719, 0.105319, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 512.5, 165.0, 90.0, 20.0 ],
					"text" : "pak dim 1024 1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 512.5, 214.0, 206.0, 20.0 ],
					"text" : "jit.matrix #1 2 float32 1024 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 537.5, 73.5, 55.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 537.5, 103.5, 50.5, 20.0 ],
					"text" : "fftinfo~",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 477.666666666666686, 303.0, 477.666666666666686, 303.0 ],
					"source" : [ "obj-60", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 477.666666666666686, 334.0, 478.666666666666686, 334.0 ],
					"source" : [ "obj-61", 0 ]
				}
