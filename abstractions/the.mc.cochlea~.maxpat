...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1389.671883265177257, 693.74450820684433, 35.0, 20.0 ],
					"text" : "defer"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2304.0, 1312.0, 150.0, 18.0 ],
					"text" : "args thru"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2280.65623346964594, 1262.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 2227.65623346964594, 1229.0, 72.0, 20.0 ],
					"text" : "pvar active 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 370.0, 523.692308068275452, 51.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 338.0, 470.225456833839417, 95.0, 20.0 ],
					"text" : "mc.gate~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1389.671883265177257, 728.0, 142.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1389.671883265177257, 794.51098358631134, 63.0, 20.0 ],
					"text" : "unpack i i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "active"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1389.671883265177257, 762.51098358631134, 84.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 1147.171883265177257, 659.48901641368866, 159.0, 20.0 ],
					"text" : "route verbose active autoclear",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1003.252808213233948, 1081.0, 150.0, 18.0 ],
					"text" : "data matrices"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-70",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.mc.jit.cochlea~" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 954.252808213233948, 585.0, 338.0, 20.0 ],
					"text" : "patcherargs @verbose 0 @exportname 0 @active 1 @autoclear 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.mc.jit.snapshot~: (jit_matrix) send a bang to inlet 2 to output latest recorded Matrix, send a bang to inlet 2 to output latest recorded Matrices",
					"id" : "obj-7",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1003.252808213233948, 1044.499995708465576, 30.0, 30.0 ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1282.752808213233948, 648.24450820684433, 1156.671883265177257, 648.24450820684433 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 608.15934020280838, 496.916665315628052, 411.5, 496.916665315628052 ],
					"source" : [ "obj-21", 0 ]
				}
