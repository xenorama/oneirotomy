...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 675.0, 244.60723876953125, 85.0, 20.0 ],
					"text" : "route 2 3 4"
				}
...
,
					"patching_rect" : [ 1367.299999999999955, 478.2144775390625, 50.0, 20.0 ],
					"saved_object_attributes" : 					{
						"color" : [ 0.937255, 0.763913, 0.302615, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2079.0, 707.2144775390625, 130.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1858.171883265177257, 616.2144775390625, 266.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1803.0, 623.2144775390625, 29.5, 20.0 ],
					"text" : "b 2",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1555.0, 644.2144775390625, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 568.0, 598.0, 32.0, 20.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 740.5, 285.2144775390625, 142.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 740.5, 342.72546112537384, 63.0, 20.0 ],
					"text" : "unpack i i i",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"varname" : "active"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 740.5, 310.72546112537384, 84.0, 20.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 749.131141424179077, 150.0, 18.0 ],
					"text" : "sample count"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 238.0, 299.0, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 173.0, 305.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 819.0, 442.2144775390625, 286.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 707.2144775390625, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 466.5, 598.0, 41.0, 20.0 ],
					"text" : "t open",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 783.5, 386.0, 172.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 568.0, 456.0, 37.0, 20.0 ],
					"text" : "== 2",
					"textcolor" : [ 0.909223, 0.56404, 0.031589, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 568.0, 427.0, 168.0, 20.0 ],
					"text" : "r #1_the.jit.rec.mode",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 675.0, 212.0, 105.0, 20.0 ],
					"text" : "route active volume",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 490.0, 173.0, 204.0, 20.0 ],
					"text" : "patcherargs @exportname 0 @active 1",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 574.0, 383.0, 594.25, 383.0, 594.25, 204.0, 684.5, 204.0 ],
					"source" : [ "obj-27", 5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 770.5, 254.10723876953125, 1230.5, 254.10723876953125 ],
					"source" : [ "obj-291", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-292", 0 ],
					"midpoints" : [ 476.0, 640.5, 819.0, 640.5 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 2088.5, 1044.8761146068573, 1434.75, 1044.8761146068573, 1434.75, 470.011185884475708, 1407.799999999999955, 470.011185884475708 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 750.5, 274.910858154296875, 750.0, 274.910858154296875 ],
					"source" : [ "obj-71", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 258.5, 577.0, 590.5, 577.0 ],
					"order" : 0,
					"source" : [ "obj-81", 0 ]
				}
