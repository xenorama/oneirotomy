...
, 							{
								"box" : 								{
									...
									"id" : "obj-9",
									"ignoreclick" : 1,
									"jsarguments" : [ "the.jit.js.renderer~" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 350.0, 105.0, 22.0 ],
					"text" : "the.jit.js.renderer~"
				}
...
,
						...
						"description" : "",
						"digest" : "",
						"tags" : "jitter glsl js gen data timing msp",
						"style" : "",
						"subpatcher_template" : "",
						"showontab" : 1,
						"assistshowspatchername" : 0,
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 719.0, 419.0, 45.0, 23.0 ],
									"text" : "sel init"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 316.0, 382.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 312.0, 576.0, 210.0, 23.0 ],
									"text" : "dict.unpack realtime_texture_input:"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 136.0, 625.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 136.0, 576.0, 165.0, 23.0 ],
									"text" : "dict.unpack output_texture:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 136.0, 540.0, 157.0, 23.0 ],
									"text" : "dict.unpack world: render:"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 125.0, 302.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"orientation" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 675.5, 291.0, 61.0, 46.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 442.0, 612.0, 170.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 155.0, 398.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 419.0, 581.0, 114.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 419.0, 656.0, 257.0, 23.0 ],
									"text" : "jit.gl.camera @position 0 0 4 @far_clip 169"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "int" ],
									"patching_rect" : [ 514.0, 542.0, 66.0, 23.0 ],
									"text" : "change 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 514.0, 447.0, 70.0, 23.0 ],
									"text" : "170, 4 150"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 514.0, 480.0, 50.0, 23.0 ],
									"text" : "bline 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 252.5, 258.0, 29.5, 23.0 ],
									"text" : "4"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.0, 258.0, 29.5, 23.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 312.0, 417.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 202.0, 382.0, 80.0, 60.0 ],
									"sync" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 202.0, 316.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 691.0, 542.0, 92.5, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 669.0, 467.0, 74.0, 23.0 ],
									"text" : "turn 0 4 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 669.0, 585.0, 177.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 669.0, 500.0, 81.0, 23.0 ],
									"text" : "jit.anim.drive"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 591.0, 349.0, 147.0, 23.0 ],
									"text" : "jit.world ctx",
...
, 							{
								"box" : 								{
									...
									"orientation" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 591.0, 291.0, 61.0, 46.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 655.0, 388.0, 80.0, 35.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 197.0, 461.0, 263.0, 38.0 ],
									"text" : ";\rmax showdoc the.jit.js.renderer~.maxref.xml"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 202.0, 349.0, 289.0, 23.0 ],
									"text" : "the.jit.js.renderer~ ctx @realtime_texture_input 1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 659.0, 98.375, 139.0, 40.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 339.0, 349.0, 205.991989135742188, 54.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 388.855987548828125, 57.599853515625 ]
				}
