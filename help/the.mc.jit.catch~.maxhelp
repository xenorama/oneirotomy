...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 168.0, 63.5, 756.0, 756.0 ],
									"uncheckedcolor" : [ 0.850980392156863, 0.0, 0.0, 1.0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"fontsize" : 598.586831623367971,
									"id" : "obj-4",
									"maxclass" : "comment",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 330.5, 111.842105263157919, 611.0, 675.0 ],
									"text" : "?",
									"textcolor" : [ 0.850980392156863, 0.0, 0.0, 1.0 ]
								}
