...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 420.523824896131373, 540.440653296586333, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 420.523824896131373, 501.0, 97.0, 22.0 ],
					"text" : "r #1_rebuild",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1014.151044882547922, 345.761411666870117, 610.999966025352478, 11.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1014.151044882547922, 253.030910968780518, 78.0, 22.0 ],
					"text" : "set name: $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1014.151044882547922, 293.761411666870117, 895.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1115.036759168262051, 253.030910968780518, 182.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1076.523824896131373, 665.440653296586333, 34.0, 22.0 ],
					"text" : "sel 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1076.523824896131373, 615.440653296586333, 147.0, 22.0 ],
					"text" : "r #1_mode.prep.pre",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 909.750005006790161, 665.440653296586333, 34.0, 22.0 ],
					"text" : "sel 2"
				}
...
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (bang) before rendering begins",
					"id" : "obj-28",
					"index" : 5,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1076.523824896131373, 704.750005960464478, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.750005006790161, 615.440653296586333, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (bang) beginning of recording",
					"id" : "obj-25",
					"index" : 4,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 909.750005006790161, 704.750005960464478, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.523824896131373, 395.5, 147.0, 22.0 ],
					"text" : "r #1_mode.prep.pre",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1093.56510324995952, 487.019700884819031, 87.0, 22.0 ],
					"text" : "prepend active"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1093.56510324995952, 521.440653296586333, 77.0, 22.0 ],
					"text" : "s #0_state",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 933.56510324995952, 398.0, 248.0, 22.0 ],
					"text" : "the.active.flag #1 init @name #0_init",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1001.151044882547922, 521.440653296586333, 91.0, 20.0 ],
					"text" : "'active'"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 956.56510324995952, 572.440653296586333, 85.0, 22.0 ],
					"text" : "s #0_record",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 933.56510324995952, 446.0, 339.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 933.56510324995952, 521.440653296586333, 65.0, 22.0 ],
					"text" : "unpack i i i",
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 933.56510324995952, 480.51098358631134, 89.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.523824896131373, 364.5, 117.0, 22.0 ],
					"text" : "r #1_launched",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.0, 398.0, 19.0, 22.0 ],
					"text" : "t l",
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.750005006790161, 398.0, 59.0, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 578.0, 199.0, 29.5, 22.0 ],
					"text" : "+ 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.523824896131373, 422.5, 151.0, 22.0 ],
					"text" : "r #1_the.jit.rec.mode",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 578.0, 170.0, 252.0, 22.0 ],
					"text" : "routepass int raw sync_dim active bang name",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 478.0, 398.0, 52.0, 22.0 ],
					"text" : "route int",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 478.0, 444.0, 54.0, 22.0 ],
					"text" : "deferlow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 478.0, 128.0, 47.0, 22.0 ],
					"text" : "zl nth 3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 810.833333333333371, 505.0, 31.5, 22.0 ],
					"text" : "join",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 505.0, 52.5, 22.0 ],
					"text" : "join",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 823.333333333333371, 445.0, 71.0, 22.0 ],
					"text" : "fromsymbol",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.666666666666742, 445.0, 71.0, 22.0 ],
					"text" : "fromsymbol",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 626.0, 398.0, 255.333333333333371, 22.0 ],
					"text" : "unjoin 3 @outsize 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 531.0, 128.0, 66.0, 22.0 ],
					"text" : "route done",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 478.0, 78.0, 204.0, 22.0 ],
					"text" : "patcherargs @active 1 @name #0",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.0, 395.5, 68.0, 49.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (attribute) specify attribute and value for rendering mode",
					"id" : "obj-7",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.750005006790161, 501.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (attribute) specify attribute and value for playback mode",
					"id" : "obj-6",
					"index" : 2,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 576.750005006790161, 501.0, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (anything)  specified attributes as per operation mode",
					"id" : "obj-4",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 379.750005006790161, 704.750005960464478, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (bang, raw) outputs a 'bang' at operation mode switch or the @raw data specified in object box",
					"id" : "obj-3",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.750005006790161, 704.750005960464478, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (dictionary) all attributes per operation mode (playback/render) ",
					"id" : "obj-2",
					"index" : 3,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 773.750005006790161, 704.750005960464478, 30.0, 30.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "the.obj.init: (anything) bool = operation mode switch (imitation); list = attributes to toggle, patcher attributes",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 453.750005006790161, 39.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 379.750005006790161, 592.750005960464478, 413.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.obj.settings.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.obj.settings.js #1 #2",
...
, 			{
				"box" : 				{
					...
					"id" : "obj-32",
					"jsarguments" : [ "the.obj.init", 70 ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 446.0, 213.000008821487427 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 463.250005006790161, 159.5, 587.5, 159.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 672.5, 113.5, 540.5, 113.5 ],
					"source" : [ "obj-10", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 487.5, 168.5, 487.5, 168.5 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 487.5, 486.875002980232239, 389.250005006790161, 486.875002980232239 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 714.277777777777828, 432.0, 669.166666666666742, 432.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 793.055555555555543, 432.0, 832.833333333333371, 432.0 ],
					"source" : [ "obj-15", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 635.5, 488.0, 820.333333333333371, 488.0 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 820.5, 274.5, 635.5, 274.5 ],
					"source" : [ "obj-21", 6 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 742.833333333333371, 244.5, 587.5, 244.5 ],
					"source" : [ "obj-21", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 665.166666666666629, 244.5, 587.5, 244.5 ],
					"source" : [ "obj-21", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 626.333333333333371, 244.5, 587.5, 244.5 ],
					"source" : [ "obj-21", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 781.666666666666629, 252.39276123046875, 943.06510324995952, 252.39276123046875 ],
					"order" : 2,
					"source" : [ "obj-21", 5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 704.0, 252.39276123046875, 943.06510324995952, 252.39276123046875 ],
					"source" : [ "obj-21", 3 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 102.023824896131373, 499.125002980232239, 389.250005006790161, 499.125002980232239 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-30", 0 ],
					"midpoints" : [ 587.5, 241.5, 587.5, 241.5 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 587.5, 486.875002980232239, 389.250005006790161, 486.875002980232239 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 1,
					"hidden" : 1,
					"midpoints" : [ 306.5, 499.125002980232239, 389.250005006790161, 499.125002980232239 ],
					"source" : [ "obj-9", 0 ]
				}
