...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 523.5, 778.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 228.0, 704.0, 29.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.5, 810.0, 154.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 828.0, 296.0, 154.0, 21.0 ],
					"text" : "index of channel"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.5, 840.60723876953125, 251.0, 8.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 789.0, 326.60723876953125, 251.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.5, 840.60723876953125, 259.0, 35.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 789.0, 326.60723876953125, 251.0, 64.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.5, 810.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 789.0, 296.0, 35.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 615.0, 459.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 402.0, 159.0, 52.0 ],
					"text" : "contains frame-based data per voice",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.5, 458.0, 194.0, 24.0 ],
					"text" : "internal voice allocation number",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 810.0, 154.0, 21.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 558.0, 296.0, 154.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 840.60723876953125, 251.0, 8.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 326.60723876953125, 251.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 840.60723876953125, 251.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 326.60723876953125, 251.0, 35.0 ],
					"text" : "data out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.0, 264.2855224609375, 138.0, 35.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 824.0, 152.2855224609375, 138.0, 35.0 ],
					"text" : "'dump' message to write data to disk"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 252.0, 212.0, 7.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 789.0, 140.0, 212.0, 7.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 218.0, 212.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 789.0, 106.0, 212.0, 35.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 264.2855224609375, 180.0, 64.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 554.0, 152.2855224609375, 180.0, 64.0 ],
					"text" : "• data to record per voice.\noutput from mc.snapshot~\n\n• frame-index during rendering"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 252.0, 212.0, 7.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 140.0, 212.0, 7.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 218.0, 212.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 106.0, 212.0, 35.0 ],
					"text" : "data in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 615.0, 549.0, 195.0, 22.0 ],
					"text" : "combine voice :: frame @triggers 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 228.0, 810.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 296.0, 35.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 615.0, 704.0, 101.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"parameter_enable" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.0, 661.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 615.0, 622.0, 93.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 330.0, 55.0, 22.0 ],
					"text" : "t dump b",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.0, 264.0, 28.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 789.0, 152.0, 28.0, 22.0 ],
					"text" : "in 2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 228.0, 459.0, 192.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0,
						"precision" : 6
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 534.0, 402.0, 56.0, 22.0 ],
					"text" : "thispoly~",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 228.0, 264.0, 28.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 519.0, 152.0, 28.0, 22.0 ],
					"text" : "in 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.5, 696.5, 176.0, 37.0 ],
					"text" : "dictionary containing every voice's frame-based data",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-29",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.mc.snapshot.voice.data" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 295.166666666666629, 518.0, 800.5, 518.0 ],
					"source" : [ "obj-15", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 237.5, 596.5, 698.5, 596.5 ],
					"order" : 0,
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 248.0, 751.5, 533.0, 751.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 543.5, 441.0, 624.5, 441.0 ],
					"order" : 0,
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 507.5, 378.5, 237.5, 378.5 ],
					"source" : [ "obj-7", 0 ]
				}
