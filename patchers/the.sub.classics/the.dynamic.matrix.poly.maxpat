...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 517.0, 277.5, 185.0, 37.0 ],
					"text" : "number of instances is based on entries in dictionary"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 170.000000460937372, 292.0, 24.0 ],
					"text" : "will output id when jit.matrixset is imported/loaded"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 526.0, 49.0, 182.0, 21.0 ],
					"text" : "• the.jit.poke~",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 526.0, 5.0, 182.0, 35.0 ],
					"text" : "parent:",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 499.7144775390625, 291.25, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 506.7144775390625, 291.25, 35.0 ],
					"text" : "jit_matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.5, 461.5, 257.0, 35.0 ],
					"text" : "jit_matrix\nthru / recompiled"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 402.999999539062628, 197.0, 37.0 ],
					"text" : "jit.matrix requires hard-coded name argument to be modified"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 468.0, 35.0, 22.0 ],
					"text" : "out 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 161.000000460937372, 167.0, 5.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 124.000000460937372, 178.0, 35.0 ],
					"text" : "setcell / output"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 49.0, 397.0, 35.0 ],
					"text" : "every instance hosts one named matrix of those dynamically changed throughout recording."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 42.0, 703.0, 10.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 5.0, 585.0, 35.0 ],
					"text" : "create all matrices contained in timeline (poly~)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 170.000000460937372, 135.0, 21.0 ],
					"text" : "messages to jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 350.0, 369.249999769531314, 65.0, 22.0 ],
					"text" : "zl 2 slice 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 396.0, 449.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 410.499999539062628, 311.0, 22.0 ],
					"text" : "prepend script replace target newex 0 0 200 12. jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 319.0, 73.0, 22.0 ],
					"text" : "prepend get"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 405.0, 285.0, 106.0, 22.0 ],
					"text" : "zl nth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 295.0, 202.5, 216.0, 22.0 ],
					"text" : "t getkeys i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 295.0, 247.0, 184.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 295.0, 170.000000460937372, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 170.0, 28.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 319.0, 200.0, 22.0 ],
					"text" : "jit.matrix poker",
					"varname" : "target"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 414.5, 349.0, 284.166666666666629, 349.0, 284.166666666666629, 236.0, 304.5, 236.0 ],
					"source" : [ "obj-10", 0 ]
				}
