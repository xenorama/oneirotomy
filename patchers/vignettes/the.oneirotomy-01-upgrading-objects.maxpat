...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 899.5, 883.0, 24.0, 24.0 ]
				}

			}
, 			{
				"box" : 				{
					"fontsize" : 44.823417203424135,
					"id" : "obj-73",
					"maxclass" : "comment",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 808.5, 54.0, 57.0 ],
					"text" : "?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 808.5, 54.0, 57.0 ],
					"text" : "?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 667.0, 54.0, 57.0 ],
					"text" : "="
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 428.5, 54.0, 57.0 ],
					"text" : "="
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 281.0, 54.0, 57.0 ],
					"text" : "?"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 181.578947368421041, 54.0, 57.0 ],
					"text" : "="
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 667.0, 54.0, 57.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 428.5, 54.0, 57.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 281.0, 54.0, 57.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 181.578947368421041, 54.0, 57.0 ],
					"text" : ">"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 769.0, 848.5, 6.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 555.0, 848.5, 6.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 397.0, 848.5, 6.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.0, 273.0, 848.5, 6.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 561.5, 94.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 930.5, 94.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.0, 94.0, 53.0, 22.0 ],
					"text" : "upgrade"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.0, 126.0, 138.0, 22.0 ],
					"text" : "the.oneirotomy.setup ctx",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 970.5, 324.0, 184.0, 24.0 ],
					"text" : "* to be implemented manually"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 502.5, 798.0, 261.0, 78.0 ],
					"text" : "bangs from jit.world can be replaced during recording using the.bang, which may only be necessary when realtime triggering of events needs to be qlimited or framerate shrinks during recording, for example. "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.5, 656.5, 170.0, 78.0 ],
					"text" : "jit.mo.func only works when jit.world is running, requires the.jit.mo.drive as phase control when rendering offline"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 584.5, 431.5, 177.0, 51.0 ],
					"text" : "jit.anim.objects require special augmentation using the.mc.data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 568.5, 284.5, 195.0, 37.0 ],
					"text" : "objects to consider augmenting using the.mc.data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.5, 203.0, 120.0, 24.0 ],
					"text" : "objects to replace"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 502.5, 734.0, 59.0, 22.0 ],
					"text" : "jit.mo.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 502.5, 678.0, 76.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 502.5, 521.0, 86.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 502.5, 414.0, 77.0, 22.0 ],
					"text" : "jit.anim.node",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 502.5, 446.0, 76.0, 22.0 ],
					"text" : "jit.anim.drive",
					"textcolor" : [ 1.0, 0.6, 0.1, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.5, 356.0, 79.0, 22.0 ],
					"text" : "prepend time"
				}
...
, 			{
				"box" : 				{
					...
					"color" : [ 1.0, 0.596, 0.059, 1.0 ],
					"id" : "obj-48",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 502.5, 292.0, 47.0, 22.0 ],
					"text" : "clocker",
					"textcolor" : [ 1.0, 0.596, 0.059, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.5, 234.0, 108.0, 22.0 ],
					"text" : "jit.poke~ target 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 502.5, 204.0, 84.0, 22.0 ],
					"text" : "mc.snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 502.5, 173.0, 64.0, 22.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.5, 94.0, 53.0, 22.0 ],
					"text" : "highlight"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 502.5, 126.0, 138.0, 22.0 ],
					"text" : "the.oneirotomy.setup ctx",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.5, 851.0, 86.0, 22.0 ],
					"text" : "s render_bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 301.0, 787.0, 76.0, 22.0 ],
					"text" : "jit.world ctx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 899.5, 851.0, 84.0, 22.0 ],
					"text" : "r render_bang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 899.5, 819.0, 224.0, 22.0 ],
					"text" : "the.render.bang ctx @send render_bang",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_matrix", "bang", "" ],
					"patching_rect" : [ 871.0, 787.0, 76.0, 22.0 ],
					"text" : "jit.world ctx"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 871.0, 678.0, 76.0, 35.0 ],
					"text" : "jit.mo.sin @speed 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 871.0, 734.0, 59.0, 22.0 ],
					"text" : "jit.mo.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.0, 644.0, 173.0, 22.0 ],
					"text" : "the.jit.mo.drive sin @speed 0.2",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.0, 611.0, 58.0, 22.0 ],
					"text" : "speed $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 871.0, 578.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 301.0, 734.0, 59.0, 22.0 ],
					"text" : "jit.mo.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 301.0, 678.0, 76.0, 35.0 ],
					"text" : "jit.mo.sin @speed 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 891.0, 484.0, 147.0, 22.0 ],
					"text" : "the.mc.data ctx @active 4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 871.0, 521.0, 86.0, 22.0 ],
					"text" : "jit.gl.gridshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.0, 414.0, 77.0, 22.0 ],
					"text" : "jit.anim.node",
					"textcolor" : [ 1.0, 0.6, 0.1, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.0, 446.0, 76.0, 22.0 ],
					"text" : "jit.anim.drive",
					"textcolor" : [ 1.0, 0.6, 0.1, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 301.0, 521.0, 86.0, 22.0 ],
					"text" : "jit.gl.gridshape"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 301.0, 414.0, 77.0, 22.0 ],
					"text" : "jit.anim.node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 301.0, 446.0, 76.0, 22.0 ],
					"text" : "jit.anim.drive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 356.0, 79.0, 22.0 ],
					"text" : "prepend time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 301.0, 292.0, 47.0, 22.0 ],
					"text" : "clocker"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.0, 356.0, 79.0, 22.0 ],
					"text" : "prepend time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "" ],
					"patching_rect" : [ 871.0, 324.0, 90.0, 22.0 ],
					"text" : "the.mc.data ctx",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 871.0, 292.0, 47.0, 22.0 ],
					"text" : "clocker",
					"textcolor" : [ 1.0, 0.596, 0.059, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "jit_matrix" ],
					"patching_rect" : [ 871.0, 234.0, 155.5, 22.0 ],
					"text" : "the.jit.poke~ ctx target 2 0",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 871.0, 204.0, 132.0, 22.0 ],
					"text" : "the.mc.snapshot~ ctx 5",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 871.0, 173.0, 103.0, 22.0 ],
					"text" : "the.snapshot~ ctx",
					"textcolor" : [ 0.937, 0.765, 0.302, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 301.0, 234.0, 108.0, 22.0 ],
					"text" : "jit.poke~ target 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 301.0, 204.0, 84.0, 22.0 ],
					"text" : "mc.snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 301.0, 173.0, 64.0, 22.0 ],
					"text" : "snapshot~"
				}
