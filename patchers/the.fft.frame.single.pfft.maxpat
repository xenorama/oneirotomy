...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.166666666666515, 512.5, 248.0, 37.0 ],
					"text" : "essentiallly a jit.poke~ object but linked with the render context of the.jit.thalamus"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 649.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 559.0, 35.0, 22.0 ],
					"text" : "out 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 335.166666666666515, 358.0, 90.0, 22.0 ],
					"text" : "fftinfo~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 315.0, 416.0, 62.833333333333201, 22.0 ],
					"text" : "!-~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.0, 520.0, 278.0, 22.0 ],
					"text" : "the.jit.poke~ #1 #2 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 553.0, 157.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.0, 416.0, 149.0, 22.0 ],
					"text" : "cartopol~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 56.0, 234.0, 278.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 56.0, 234.0, 166.0, 22.0 ],
					"text" : "fftin~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.166666666666515, 234.0, 142.833333333333485, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.280424336592205, 358.0, 95.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.280424336592205, 223.0, 386.0, 9.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.280424336592205, 187.0, 386.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.280424336592205, 234.0, 389.0, 179.0 ],
					"presentation" : 1,
					"presentation_linecount" : 12,
					"presentation_rect" : [ 39.0, 146.0, 389.0, 179.0 ],
					"text" : "args:\n#1 (symbol) = render context name\n#2 (symbol) = spectral matrix name\n\nthe target (spectral) matrix must initialise to the following settings:\n\nplanecount: 1 (amplitudes only)\ntype: float32\ndim: spectral frame size (half of full spectrum)\n\narguments are applied to pfft~ by appending the word 'args' followed by respective arguments in the object box (without @-symbol)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.280424336592205, 443.000000230468686, 78.0, 24.0 ],
					"text" : "amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.140212168296102, 443.000000230468686, 47.0, 52.0 ],
					"text" : "phase (idle)",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.166666666666515, 339.0, 130.0, 8.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.166666666666515, 305.0, 130.0, 35.0 ],
					"text" : "frame size"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 680.000000230468686, 322.0, 9.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 590.000000230468686, 322.0, 9.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 315.0, 680.000000230468686, 322.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 315.0, 590.000000230468686, 322.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.5, 636.0, 283.5, 35.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 353.5, 546.0, 283.5, 35.0 ],
					"text" : "monitor fft frame as single-plane matrix (amplitudes only), connect to a jit.pwindow for example"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 222.0, 422.0, 8.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 188.0, 212.0, 35.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Record single FFT frames for offline-rendering"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-29",
					"ignoreclick" : 1,
					"jsarguments" : [ "the.fft.frame.pfft" ],
					"maxclass" : "jsui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.0, 6.0, 541.0, 53.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 195.0, 275.0, 195.5, 275.0 ],
					"source" : [ "obj-61", 1 ]
				}
