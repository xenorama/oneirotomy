...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 426.0, 496.75, 103.523824896131373, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 680.0, 562.75, 73.0, 22.0 ],
					"text" : "r #0_print",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.023824896131373, 431.75, 153.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 483.0, 180.0, 22.0, 22.0 ],
					"text" : "t 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 114.523824896131373, 239.0, 98.0, 22.0 ],
					"text" : "gate 2 2",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 643.0, 507.75, 171.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 273.5, 334.375, 222.333333333333371, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 426.0, 431.75, 236.0, 22.0 ],
					"text" : "route done ignore_handles verbose",
...
, 			{
				"box" : 				{
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.666666666666629, 496.75, 67.523824896131373, 44.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 483.0, 148.0, 72.0, 22.0 ],
					"text" : "patcherargs",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "the.oneirotomy.setup: (dictionary) lists all found objs",
					"id" : "obj-5",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.523824896131373, 816.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 647.75, 146.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.523824896131373, 334.375, 140.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 114.523824896131373, 272.0, 178.0, 22.0 ],
...
, 			{
				"box" : 				{
					"comment" : "the.oneirotomy.setup: (notification) command execution notification",
					"id" : "obj-9",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.523824896131373, 816.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 114.523824896131373, 675.0, 37.0, 22.0 ],
					"text" : "t l b",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.523824896131373, 516.375, 66.0, 22.0 ],
					"text" : "t b l zlclear",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.523824896131373, 745.0, 36.0, 22.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 132.523824896131373, 712.0, 48.0, 22.0 ],
					"text" : "del 333",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.523824896131373, 481.75, 42.0, 22.0 ],
					"text" : "thresh",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 114.523824896131373, 592.0, 54.0, 22.0 ],
					"text" : "zl queue",
...
, 			{
				"box" : 				{
					"comment" : "the.oneirotomy.setup: (commands) send patch highlighting and transformation commands",
					"id" : "obj-1",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.523824896131373, 148.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 114.523824896131373, 638.0, 252.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "the.obj.finder.js",
						"parameter_enable" : 0
					}
,
					"text" : "js the.obj.finder.js #1 #0",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 545.5, 403.5625, 435.5, 403.5625 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 580.166666666666629, 625.5, 124.023824896131373, 625.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 507.833333333333314, 474.75, 435.5, 474.75 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.833333333333371, 393.875, 124.023824896131373, 393.875 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 652.5, 588.25, 652.5, 588.25 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 492.5, 212.5, 124.023824896131373, 212.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-12", 0 ],
					"midpoints" : [ 203.523824896131373, 564.75, 652.5, 564.75 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 142.023824896131373, 781.0, 395.0, 781.0, 395.0, 581.0, 124.023824896131373, 581.0 ],
					"source" : [ "obj-55", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 171.023824896131373, 564.6875, 124.023824896131373, 564.6875 ],
					"source" : [ "obj-64", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 147.523824896131373, 564.6875, 124.023824896131373, 564.6875 ],
					"source" : [ "obj-64", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 124.023824896131373, 564.6875, 124.023824896131373, 564.6875 ],
					"source" : [ "obj-64", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 435.5, 625.875, 124.023824896131373, 625.875 ],
					"source" : [ "obj-8", 0 ]
				}
