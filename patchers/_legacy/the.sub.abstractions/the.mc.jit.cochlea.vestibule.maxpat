...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 299.0, 81.0, 20.0 ],
					"text" : "prepend plane"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 96.0, 269.0, 29.5, 20.0 ],
					"text" : "- 1",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 96.0, 239.0, 56.0, 20.0 ],
					"text" : "thispoly~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 96.0, 209.0, 55.0, 20.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 238.0, 163.0, 37.0, 20.0 ],
					"text" : "in~ 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 38.0, 163.0, 37.0, 20.0 ],
					"text" : "in~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 360.499995708465576, 219.0, 20.0 ],
					"text" : "jit.poke~ #1 1 0",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 44.0, 410.0, 20.0 ],
					"text" : "…"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 18.0, 408.0, 38.0 ],
					"text" : "mc.jit.cochlea.vestibule"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 5.0, 792.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 18.0, 792.0, 24.0 ],
					"text" : "poly~ instance within mc.jit.cochlea~",
					"varname" : "title[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 106.2144775390625, 410.0, 20.0 ],
					"text" : "args:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 5.2144775390625, 408.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 62.2144775390625, 410.0, 24.0 ],
					"text" : "info~"
				}
