...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 127.0, 299.0, 29.5, 20.0 ],
					"text" : "==",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 338.0, 31.0, 20.0 ],
					"text" : "gate",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 67.0, 299.0, 45.0, 20.0 ],
					"text" : "route 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 67.0, 269.0, 79.0, 20.0 ],
					"text" : "bondo",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 229.0, 28.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 439.0, 35.0, 20.0 ],
					"text" : "defer",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 372.0, 245.0, 80.0, 20.0 ],
					"text" : "phasewrap~",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 633.0, 324.0, 215.0, 20.0 ],
					"text" : "poltocar~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 829.0, 260.0, 90.0, 20.0 ],
					"text" : "frameaccum~",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 829.0, 205.0, 139.0, 20.0 ],
					"text" : "jit.peek~ #1 1 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 633.0, 205.0, 157.0, 20.0 ],
					"text" : "jit.peek~ #1 1 0",
					"textcolor" : [ 0.937255, 0.763913, 0.302615, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 364.0, 79.0, 20.0 ],
					"text" : "prepend dim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 372.0, 205.0, 83.0, 20.0 ],
					"text" : "framedelta~",
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.233228, 0.395064, 0.427586, 1.0 ],
					"color" : [ 0.401425, 0.60809, 0.055461, 1.0 ],
					"fontname" : "Theinhardt Light",
					"fontsize" : 12.0,
					"id" : "obj-20",
					"maxclass" : "newobj",
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 633.0, 399.0, 215.0, 20.0 ],
					"text" : "fftout~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 254.0, 301.0, 136.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 96.0, 154.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 481.0, 40.0, 20.0 ],
					"text" : "out 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 59.0, 31.0, 20.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 254.0, 154.0, 137.0, 20.0 ],
					"text" : "cartopol~",
					"textcolor" : [ 0.481539, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 59.0, 81.0, 20.0 ],
					"text" : "fftinfo~",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 254.0, 59.0, 254.0, 20.0 ],
					"text" : "fftin~ 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 254.0, 399.0, 304.0, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 381.5, 281.0, 380.5, 281.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 838.5, 371.0, 838.5, 371.0 ],
					"source" : [ "obj-14", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 838.5, 301.5, 838.5, 301.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 136.5, 392.0, 263.5, 392.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 105.5, 200.0, 263.5, 200.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-21", 0 ],
					"midpoints" : [ 223.5, 199.0, 263.5, 199.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 76.166666666666671, 116.0, 105.5, 116.0 ],
					"order" : 0,
					"source" : [ "obj-28", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 76.166666666666671, 165.0, 76.5, 165.0 ],
					"order" : 1,
					"source" : [ "obj-28", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 498.5, 123.0, 677.0, 123.0, 677.0, 123.0, 838.5, 123.0 ],
					"order" : 0,
					"source" : [ "obj-29", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 498.5, 123.0, 642.5, 123.0 ],
					"order" : 1,
					"source" : [ "obj-29", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 381.0, 144.0, 381.5, 144.0 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 102.5, 328.0, 148.5, 328.0 ],
					"source" : [ "obj-5", 1 ]
				}
