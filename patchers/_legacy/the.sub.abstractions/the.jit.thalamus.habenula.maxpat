...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.0, 620.89276123046875, 52.0, 20.0 ],
					"text" : "zl slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 328.0, 620.89276123046875, 102.0, 20.0 ],
					"text" : "route default listen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.671883265177371, 805.0, 150.0, 18.0 ],
					"text" : "value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 246.0, 357.0, 150.0, 18.0 ],
					"text" : "set value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.671883265177371, 357.0, 150.0, 18.0 ],
					"text" : "loadbang in parent patcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.0, 591.39276123046875, 150.0, 30.0 ],
					"text" : "avoid console errors when #5 omitted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 672.39276123046875, 68.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 406.0, 591.39276123046875, 45.0, 20.0 ],
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 552.39276123046875, 167.0, 20.0 ],
					"text" : "loadmess #5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 432.0, 703.64276123046875, 44.0, 20.0 ],
					"text" : "receive",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 305.0, 653.39276123046875, 71.5, 20.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.0, 591.39276123046875, 75.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.0, 477.39276123046875, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.0, 383.000000230468743, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.0, 237.000000230468743, 305.0, 32.0 ],
					"text" : ";\rmax launchbrowser https://en.wikipedia.org/wiki/Habenula"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.671883265177371, 703.64276123046875, 98.328116734822629, 20.0 ],
					"text" : "zl reg #4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 101.671883265177371, 703.64276123046875, 81.0, 20.0 ],
					"text" : "route #3",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dir" ],
					"patching_rect" : [ 133.171883265177371, 586.39276123046875, 59.0, 20.0 ],
					"text" : "t #3",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dir" ],
					"patching_rect" : [ 70.671883265177371, 443.0, 59.0, 20.0 ],
					"text" : "t #3",
					"textcolor" : [ 0.921569, 0.917647, 0.933333, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.671883265177371, 615.17828369140625, 70.0, 20.0 ],
					"text" : "prepend get"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 132.671883265177371, 552.17828369140625, 205.0, 20.0 ],
					"text" : "sel 1 0",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.671883265177371, 477.39276123046875, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.671883265177371, 519.39276123046875, 113.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 70.671883265177371, 383.000000230468743, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.671883265177371, 771.89276123046875, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 21.0, 458.0, 38.0 ],
					"text" : "the.jit.thalamus.habenula"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 109.2144775390625, 468.0, 105.0 ],
					"text" : "args:\n\n#1 (symbol) = #1 from parent patcher (render context name)\n#2 (symbol) = dictionary name\n#3 (symbol) = settings entry (dictionary)\n#4 (anything) = value(s) if entry has not been previously stored (i.e. the default)\n#5 (symbol) = receive port expecting the same data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 8.2144775390625, 458.0, 11.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 65.2144775390625, 410.0, 24.0 ],
					"text" : "access render context dictionary data"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 235.171883265177371, 747.26776123046875, 111.171883265177371, 747.26776123046875 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 255.5, 507.89276123046875, 80.171883265177371, 507.89276123046875 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-39", 0 ],
					"midpoints" : [ 142.171883265177371, 648.17828369140625, 60.171883265177371, 648.17828369140625, 60.171883265177371, 508.39276123046875, 80.171883265177371, 508.39276123046875 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 441.5, 747.26776123046875, 111.171883265177371, 747.26776123046875 ],
					"source" : [ "obj-88", 0 ]
				}
